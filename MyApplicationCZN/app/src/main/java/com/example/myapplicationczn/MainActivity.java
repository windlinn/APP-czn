...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 构造tab对象
        message =new Tab(new Fragment_wechat(),findViewById(R.id.tab_wechat), findViewById(R.id.wechattext),findViewById(R.id.wechat),getResources().getColor(R.color.selected),R.color.common) ;
        contact =new Tab(new Fragment_contact() ,findViewById(R.id.tab_contact),findViewById(R.id.contacttext) ,findViewById(R.id.contact),getResources().getColor(R.color.selected),R.color.common);
        find    =new Tab(new Fragment_find()    ,findViewById(R.id.tab_find)   ,findViewById(R.id.findtext)    ,findViewById(R.id.find)   ,getResources().getColor(R.color.selected),R.color.common);
        config  =new Tab(new Fragment_me()  ,findViewById(R.id.tab_me) ,findViewById(R.id.metext)  ,findViewById(R.id.me) ,getResources().getColor(R.color.selected),R.color.common);
